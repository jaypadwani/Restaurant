...
<Text style={{color:'grey', fontWeight: 'bold', fontSize: 20,paddingLeft:5,marginTop:5}}>
            Best Experience
          </Text>
          <Text style={{color:'grey', fontWeight: 'bold', fontSize: 20,paddingLeft:5,}}>
           So pleasant.
          </Text>


          <Text style={{color:'black', fontWeight: 'bold', fontSize: 25,paddingLeft:5,marginTop:15}}>
 Discount
          </Text>
          ...
          <Image 
            ...
            style={{height: 200, width: '100%',borderRadius:25,marginTop:15,marginBottom:20}}
          />
